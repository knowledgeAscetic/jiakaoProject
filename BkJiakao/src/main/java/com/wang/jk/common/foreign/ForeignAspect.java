package com.wang.jk.common.foreign;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.service.IService;
import com.wang.jk.common.foreign.anno.ForeignCascade;
import com.wang.jk.common.foreign.anno.ForeignField;
import com.wang.jk.common.foreign.anno.ForeignField.*;
import com.wang.jk.common.foreign.info.ForeignFieldInfo;
import com.wang.jk.common.foreign.info.ForeignTableInfo;
import com.wang.jk.common.util.Classes;
import com.wang.jk.common.util.JsonVos;
import com.wang.jk.common.util.Strings;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/wang/jk/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.wang.jk.service..*.remove*(..))")
    ...
    @Around("execution(* com.wang.jk.service..*.save*(..)) || execution(* com.wang.jk.service..*.update*(..)) ")
